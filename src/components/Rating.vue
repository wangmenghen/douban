<template>
  <div class="rating" v-if="rating">
    ...
    <template v-else>
      <template v-for="(n, key) in full">
        <span class="star-full" :key="`${key}-full`"></span>
      </template>
      <template v-for="(n, key) in half">
        <span class="star-half" :key="`${key}-half`"></span>
      </template>
      <template v-for="(n, key) in gray">
        <span class="star-gray" :key="`${key}-gray`"></span>
      </template>
