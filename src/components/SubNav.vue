<template>
  <div class="sub-nav">
    ...
    <div class="navBottom" v-if="mold === 'navBottom'">
      <div class="nav-item">
        <router-link :to="{name: 'Register'}">注册帐号</router-link><!-- replace blank
        -->
    ...
    <div class="quickNav" v-if="mold === 'quickNav'">
      <ul class="quick-nav">
        ...
        <li>
          <router-link :to="{name: 'Status'}">欧美新碟榜</router-link>
        </li>
        <li>
        ...
        <li>
          ...
          <!-- <template v-else> -->
          <template>
            <router-link :to="{name: 'Login'}" replace>登录豆瓣</router-link>
          </template>
        </li>
      </ul>
    </div>
