    ...
    <template v-if="!showLoading">
      <div class="info">
        ...
        <div class="describe">
          ...
          <!-- <div v-if="eventItem.content" class="content">{{ content }}</div> -->
        </div>
      </div>
...
import { GET_SINGLE_EVENT } from '@/store/actions'
...
export default {
  ...
  computed: {
    content: function () {
      ...
      return this.eventItem.content.replace(/src=/ig, 'v-lazy=')
      // return this.eventItem.content
    },
  ...
  created () {
    ...
    this.$store.dispatch(GET_SINGLE_EVENT, id)
    if (this.eventItem) {
